...
def eval(golddir, systemdir):
    ...
    precision_pairs = float(tp_pairs) / (float(tp_pairs) + float(fp_pairs) + 1e-80)
    recall_pairs = float(tp_pairs) / (float(tp_pairs) + float(fn_pairs) + 1e-80)
    ...
    precision_pairs_value = float(tp_pairs_value) / (float(tp_pairs_value) + float(fp_pairs_value) + 1e-80)
    recall_pairs_values = float(tp_pairs_value) / (float(tp_pairs_value) + float(fn_pairs_value) + 1e-80)
